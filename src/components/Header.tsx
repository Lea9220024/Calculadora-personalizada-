      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between py-4 gap-4">
          ...
          <div className="flex items-center justify-center bg-zinc-900/90 p-1.5 rounded-xl border border-zinc-800 shadow-inner">
            ...
            {!isCurrentMonth && <button onClick={() => onMonthChange(getCurrentMonthKey())} className="ml-2 text-xs px-2.5 py-1 rounded-md bg-zinc-900 text-emerald-400 border border-emerald-500/20 hover:bg-zinc-800 font-bold transition-colors" id="current-month-btn">Hoy</button>}
          </div>
