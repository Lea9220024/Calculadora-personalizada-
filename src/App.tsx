...
import { Category, FinancialCard, InstallmentPlan, MonthlyBudget, Subscription, Transaction, ViewTab, AppSettings } from './types';
...
const STORAGE_KEYS = { TRANSACTIONS: 'mis_gastos_transactions_v1', CATEGORIES: 'mis_gastos_categories_v1', BUDGETS: 'mis_gastos_budgets_v1', SETTINGS: 'mis_gastos_settings_v1', CARDS: 'cream_financial_cards_v1', INSTALLMENTS: 'cream_installment_plans_v1', SUBSCRIPTIONS: 'cream_subscriptions_v1' };
