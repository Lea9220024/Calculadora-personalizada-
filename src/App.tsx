...
export default function App() {
  ...
  const handleDeletePatrimony = (id: string) => { if (window.confirm('¿Eliminar este registro patrimonial?')) { setPatrimonyItems(prev => prev.filter(i => i.id !== id)); syncInBackground(() => deletePatrimonyItemFromSupabase(id), 'la eliminación patrimonial'); } };
